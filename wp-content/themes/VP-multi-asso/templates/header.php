    ...
    <div class="row">
          <div class="<?php echo esc_attr($logocclass); ?> clearfix kad-header-left">
            <div id="logo" class="logocase">
              ...
              <?php // modified part by PLM
if (!empty($virtue_premium['logo_below_text']) && is_front_page()) { ?> <div class="kad_tagline belowlogo-text"><?php echo $virtue_premium['logo_below_text']; ?></div> <?php }?>
            </div> <!-- Close #logo -->
          </div><!-- close col-md-4 -->
          <?php if(isset($virtue_premium['logo_layout']) && $virtue_premium['logo_layout'] == 'logowidget') { ?>
              <div class="col-md-8 kad-header-widget"> <?php // modified part by PLM
                if(is_active_sidebar('headerwidget') && is_front_page()) { dynamic_sidebar('headerwidget'); } ?>
              </div>
            </div>
          <div class="row"> 
          <?php } ?>
