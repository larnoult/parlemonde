...
<div id="topbar" class="topclass">
    <div class="container">
      <div class="row">
		...
		<div id="welcome-plm"> <a href="http://asso.parlemonde.org/nous-soutenir/"> <?php _e('Support the NGO <span class=\'plm\'>Par Le Monde</span>: <strong>  your donations make our actions ! </strong>','VP-asso'); ?> 
		<svg id="heart" viewBox="0 0 32 32">
		<path id="heart-path" d="M16,28.261c0,0-14-7.926-14-17.046c0-9.356,13.159-10.399,14-0.454c1.011-9.938,14-8.903,14,0.454
		    C30,20.335,16,28.261,16,28.261z"></path></svg>
		</a></div> 
