...
class RW_Taxonomy_Meta_Kad {
	...
	function check_field_date() {
		...
		wp_enqueue_style( 'jquery-ui-smoothness2', '//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.min.css' );
	...
	function check_field_time() {
		...
		wp_enqueue_script( 'jquery-ui-timepicker', '//cdn.jsdelivr.net/jquery.ui.timepicker.addon/1.3/jquery-ui-timepicker-addon.min.js', array( 'jquery-ui-datepicker', 'jquery-ui-slider' ) );
