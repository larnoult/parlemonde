...
$.imgupload2 = function(){
 ...
 (function($){
    ...
    $.virtuegallery = $.virtuegallery || {};
    
    $(document).ready(function () {
        $.virtuegallery();
    });

    $.virtuegallery = function(){
        // When the user clicks on the Add/Edit gallery button, we need to display the gallery editing
        $('body').on({
            click: function(event){
...
(function($){
    ...
    $.virtue_attachment_gallery = $.virtue_attachment_gallery || {};
    
    $(document).ready(function () {
        $.virtue_attachment_gallery();
    });

    $.virtue_attachment_gallery = function(){
        // When the user clicks on the Add/Edit gallery button, we need to display the gallery editing
        $('body').on({
            click: function(event){
                var current_gallery = $(this).closest('.kad_widget_image_gallery');
