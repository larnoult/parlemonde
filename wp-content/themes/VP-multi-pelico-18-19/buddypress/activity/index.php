...
<div id="buddypress">
	...
	<?php if ( is_user_logged_in() && $member_type!="explorateur-en-herbe" ) : ?>
...
<?php } 
	...
	<div id="buddypress"> 
	Pour consulter les questions-réponses entre classes, <a href="http://pelico.parlemonde.org/wp-login.php" target="_blank">il faut-être connecté ! </a>
	</div>
<?php }