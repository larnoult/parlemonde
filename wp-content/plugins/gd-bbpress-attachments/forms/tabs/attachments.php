        ...
        <fieldset>
            ...
            <table class="form-table">
                <tbody>
                    ...
                    <tr valign="top">
                        <th scope="row"><label for="hide_from_visitors"><?php _e("Hide attachements", "gd-bbpress-attachments"); ?></label></th>
                        <td>
                            <input class="widefat" type="checkbox" <?php if ($options["hide_from_visitors"] == 1) echo " checked"; ?> name="hide_from_visitors" />
