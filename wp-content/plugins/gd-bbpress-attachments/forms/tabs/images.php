...
<form action="" method="post">
    ...
    <div class="d4p-settings">
        ...
        <fieldset>
            ...
            <p><?php _e("Changing thumbnails size affects only new image attachments. To use new size for old attachments, resize them using", "gd-bbpress-attachments"); ?> <a href="https://wordpress.org/plugins/regenerate-thumbnails/" target="_blank">Regenerate Thumbnails</a> <?php _e("plugin", "gd-bbpress-attachments"); ?>.</p>
            <table class="form-table">
                <tbody>
                    <tr valign="top">
