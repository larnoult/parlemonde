(function($) {
    ...
    var passed_data = content_protector_data;
    ...
    //  content_protector_plugin.  If we called it my_cool_plugin, the first parameter would change
    //  to 'tinymce.plugins.my_cool_plugin'.
    tinymce.create('tinymce.plugins.content_protector_plugin', {
        init: function(editor, url) {   //  Documentation: http://www.tinymce.com/wiki.php/API3:method.tinymce.Plugin.init
            ...
            //  given in tinymce-dev-starter.php. In this case, it is content_protector_button.
            editor.addButton('content_protector_button', {
                title: "Content Protector Shortcode",//    Tooltip when hovering over button.
                image: url + '/tinymce-button.png',    //    The image for the button.
                cmd: 'content_protector_command'                    //    The editor command to execute on button click.
            });

            //  Step 2b: Define the "command" executed on button click.
            editor.addCommand('content_protector_command', function() {
                /**
    ...
    tinymce.PluginManager.add('content_protector_plugin', tinymce.plugins.content_protector_plugin);
})(jQuery);