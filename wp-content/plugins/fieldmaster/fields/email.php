...
/*
*  FieldMaster Email Field Class
*
*  All the logic for this field type
*
*  @class 		fieldmaster_field_email
*  @extends		fieldmaster_field
*  @package		FieldMaster
*  @subpackage	Fields
*/

if( ! class_exists('fieldmaster_field_email') ) :

class fieldmaster_field_email extends fieldmaster_field {
	...
	*/
	...
	function __construct() {
		...
		// vars
		$this->name = 'email';
		$this->label = __("Email",'fieldmaster');
		$this->defaults = array(
			'default_value'	=> '',
			'placeholder'	=> '',
			'prepend'		=> '',
...
// initialize
fieldmaster_register_field_type( new fieldmaster_field_email() );
