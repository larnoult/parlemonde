...
if( ! class_exists('fieldmaster_loop') ) :

class fieldmaster_loop {
...
// initialize
fieldmaster()->loop = new fieldmaster_loop();
...
/*
*  fieldmaster_add_loop
*
*  alias of fieldmaster()->loop->add_loop()
*
*  @type	function
*  @date	6/10/13
*  @since	5.0.0
...
function fieldmaster_add_loop( $loop = array() ) {
	
	return fieldmaster()->loop->add_loop( $loop );
	
}


/*
*  fieldmaster_update_loop
*
*  alias of fieldmaster()->loop->update_loop()
*
*  @type	function
*  @date	6/10/13
*  @since	5.0.0
...
function fieldmaster_update_loop( $i = 'active', $key = null, $value = null ) {
	
	return fieldmaster()->loop->update_loop( $i, $key, $value );
	
}


/*
*  fieldmaster_get_loop
*
*  alias of fieldmaster()->loop->get_loop()
*
*  @type	function
*  @date	6/10/13
*  @since	5.0.0
...
function fieldmaster_get_loop( $i = 'active', $key = null ) {
	
	return fieldmaster()->loop->get_loop( $i, $key );
...
*
*  alias of fieldmaster()->loop->remove_loop()
*
*  @type	function
*  @date	6/10/13
*  @since	5.0.0
...
function fieldmaster_remove_loop( $i = 'active' ) {
	
	return fieldmaster()->loop->remove_loop( $i );
