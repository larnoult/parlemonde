...
class QuizMaster_Model_LockMapper extends QuizMaster_Model_Mapper
{
    protected $_table;
    ...
    /**
     * @param QuizMaster_Model_Lock $lock
     *
     * @return false|int
     */
    public function insert(QuizMaster_Model_Lock $lock)
    {
     ...
     * @param int $userId
     *
     * @return null|QuizMaster_Model_Lock
     */
    public function fetch($quizId, $lockIp, $userId)
    {
        ...
        return $row !== null ? new QuizMaster_Model_Lock($row) : null;
    }
