jQuery(function($) {
	$(document).ready(function(){
		...
		$('#wp-content-media-buttons').append('<a style="margin-left:5px;" class="button" title="'+tinymceOptions.textAdd+'" id="map_button_text" href="#"><div style="float:left;"><img src="'+tinymceOptions.leafletPluginUrl+'inc/img/icon-tinymce.png" style="padding:0 5px 3px 0;"></div><div style="float:right;padding-top:0px;">'+tinymceOptions.textAdd+'</div></a>');
	});
});
