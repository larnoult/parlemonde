...
class ACS_Color_Schemes {
	...
	function add_colors() {
		...
		wp_admin_css_color(
			'GreenPelico', __( 'GreenPelico', 'admin_schemes' ),
			plugins_url( "GreenPelico/colors$suffix.css", __FILE__ ),
			array( '#87bc4b', '#adf060', '#fff380', '#658c38' ),
			array( 'base' => '#e4e5e7', 'focus' => '#fff', 'current' => '#fff' )
		);

		wp_admin_css_color(
			'PurpleProf', __( 'PurpleProf', 'admin_schemes' ),
			plugins_url( "PurpleProf/colors$suffix.css", __FILE__ ),
			array( '#87bc4b', '#adf060', '#adf060', '#4f518c' ),
			array( 'base' => '#87bc4b', 'focus' => '#fff', 'current' => '#fff' )
		);
