...
if (basename($_SERVER['SCRIPT_FILENAME']) == 'class-google-places-geocoding.php') { die ("Please do not access this file directly. Thanks!<br/><a href='https://www.mapsmarker.com/go'>www.mapsmarker.com</a>"); }
...
function lmm_initiate_google_places_endpoint(){
	...
	if
	(
		(isset($lmm_options['capabilities_view_others'])) //info: to prevent PHP warnings
		&&
		(
		(current_user_can('activate_plugins'))
		||
			(
				(isset($lmm_options['capabilities_view_others']))
				&&
				(current_user_can($lmm_options[ 'capabilities_view_others' ]))
			)
		)
	)
	{
