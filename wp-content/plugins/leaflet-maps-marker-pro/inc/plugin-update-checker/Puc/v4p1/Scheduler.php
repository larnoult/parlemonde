<?php
if ( !class_exists('MMPPuc_v4p1_Scheduler', false) ):

	/**
	 * The scheduler decides when and how often to check for updates.
	 * It calls @see MMPPuc_v4p1_UpdateChecker::checkForUpdates() to perform the actual checks.
	 */
	class MMPPuc_v4p1_Scheduler {
		public $checkPeriod = 24; //How often to check for updates (in hours).
		public $throttleRedundantChecks = false; //Check less often if we already know that an update is available.
		public $throttledCheckPeriod = 120;

		protected $hourlyCheckHooks = array('load-update.php');

		/**
		 * @var MMPPuc_v4p1_UpdateChecker
		 */
		 ...
		 *
		 * @param MMPPuc_v4p1_UpdateChecker $updateChecker
