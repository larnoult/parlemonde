<?php
if ( !class_exists('MMPPuc_v4p1_Vcs_BitBucketApi', false) ):

	class MMPPuc_v4p1_Vcs_BitBucketApi extends MMPPuc_v4p1_Vcs_Api {
		/**
		 * @var MMPPuc_v4p1_OAuthSignature
		 */
		private $oauth = null;
		...
		public function setAuthentication($credentials) {
			...
			if ( !empty($credentials) && !empty($credentials['consumer_key']) ) {
				$this->oauth = new MMPPuc_v4p1_OAuthSignature(
