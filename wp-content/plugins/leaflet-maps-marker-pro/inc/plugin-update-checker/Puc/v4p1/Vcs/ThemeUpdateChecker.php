...
if ( !class_exists('MMPPuc_v4p1_Vcs_ThemeUpdateChecker', false) ):

	class MMPPuc_v4p1_Vcs_ThemeUpdateChecker extends MMPPuc_v4p1_Theme_UpdateChecker implements MMPPuc_v4p1_Vcs_BaseChecker {
		/**
		...
		/**
		 * @var MMPPuc_v4p1_Vcs_Api Repository API client.
		 */
		protected $api = null;

		/**
		 * MMPPuc_v4p1_Vcs_ThemeUpdateChecker constructor.
		 *
		 * @param MMPPuc_v4p1_Vcs_Api $api
		...
		public function requestUpdate() {
			...
			$update = new MMPPuc_v4p1_Theme_Update();
			...
			$update->version = MMPPuc_v4p1_Utils::findNotEmpty(array(
				$remoteHeader['Version'],
				MMPPuc_v4p1_Utils::get($updateSource, 'version'),
			));

			//The details URL defaults to the Theme URI header or the repository URL.
			$update->details_url = MMPPuc_v4p1_Utils::findNotEmpty(array(
