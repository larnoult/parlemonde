...
if ( !class_exists('MMPPuc_v4p1_Vcs_GitHubApi', false) ):

	class MMPPuc_v4p1_Vcs_GitHubApi extends MMPPuc_v4p1_Vcs_Api {
		/**
		 ...
		 *
		 * @return MMPPuc_v4p1_Vcs_Reference|null
		 */
		public function getLatestRelease() {
			...
			$reference = new MMPPuc_v4p1_Vcs_Reference(array(
			...
			if ( !empty($release->body) ) {
				...
				$reference->changelog = MMPParsedown::instance()->text($release->body);
			}
		...
		public function getLatestTag() {
			...
			$tag = $versionTags[0];
			return new MMPPuc_v4p1_Vcs_Reference(array(
				'name' => $tag->name,
		 ...
		 * @return null|MMPPuc_v4p1_Vcs_Reference
		 */
