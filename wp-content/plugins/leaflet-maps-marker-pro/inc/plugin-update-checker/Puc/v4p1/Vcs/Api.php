<?php
if ( !class_exists('MMPPuc_v4p1_Vcs_Api') ):

	abstract class MMPPuc_v4p1_Vcs_Api {
		...
		/**
		 * MMPPuc_v4p1_Vcs_Api constructor.
		 *
		...
		public function getRemoteChangelog($ref, $localDirectory) {
			...
			return MMPParsedown::instance()->text($changelog);
		}
