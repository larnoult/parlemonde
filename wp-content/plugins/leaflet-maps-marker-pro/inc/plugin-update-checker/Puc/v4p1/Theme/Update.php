...
if ( !class_exists('MMPPuc_v4p1_Theme_Update', false) ):

	class MMPPuc_v4p1_Theme_Update extends MMPPuc_v4p1_Update {
		public $details_url = '';
		 ...
		 *
		 * @param StdClass|MMPPuc_v4p1_Theme_Update $object The source object.
		 * @return MMPPuc_v4p1_Theme_Update The new copy.
		 */
