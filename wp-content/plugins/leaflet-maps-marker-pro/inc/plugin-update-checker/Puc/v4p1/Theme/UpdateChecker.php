...
if ( !class_exists('MMPPuc_v4p1_Theme_UpdateChecker', false) ):

	class MMPPuc_v4p1_Theme_UpdateChecker extends MMPPuc_v4p1_UpdateChecker {
		 ...
		 *
		 * @return MMPPuc_v4p1_Update|null An instance of Update, or NULL when no updates are available.
		 */
		public function requestUpdate() {
			list($themeUpdate, $result) = $this->requestMetadata('MMPPuc_v4p1_Theme_Update', 'request_update');

			if ( $themeUpdate !== null ) {
				/** @var MMPPuc_v4p1_Theme_Update $themeUpdate */
		...
		protected function createScheduler($checkPeriod) {
			return new MMPPuc_v4p1_Scheduler($this, $checkPeriod, array('load-themes.php'));
		}
		...
		protected function createDebugBarExtension() {
			return new MMPPuc_v4p1_DebugBar_Extension($this, 'MMPPuc_v4p1_DebugBar_ThemePanel');
		}
