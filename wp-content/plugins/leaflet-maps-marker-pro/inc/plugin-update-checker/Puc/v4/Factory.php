<?php
if ( !class_exists('MMPPuc_v4_Factory', false) ):
	...
	class MMPPuc_v4_Factory {
		 ...
		 *
		 * @see MMPPuc_v4p1_UpdateChecker::__construct
		 *
		 ...
		 * @return MMPPuc_v4p1_Plugin_UpdateChecker|MMPPuc_v4p1_Theme_UpdateChecker|MMPPuc_v4p1_Vcs_BaseChecker
		 */
