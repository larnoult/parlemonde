...
if ( !class_exists('MMPPucReadmeParser', false) ):

/**
 * This is a slightly modified version of github.com/markjaquith/WordPress-Plugin-Readme-Parser
 * It uses MMPParsedown instead of the "Markdown Extra" parser.
 */

class MMPPucReadmeParser {
